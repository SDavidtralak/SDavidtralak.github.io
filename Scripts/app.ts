...
(function()
{
    function AuthGuard(): void
    {
        ...
        if(protected_route.indexOf(router.ActiveLink) > -1){
            ...
            if(!sessionStorage.getItem("user"))
            {
                ...
                // if not change the active link to login page
    ...
    function LoadLink(link: string, data: string = ""): void
    {
        ...
        //captilize the active link ans set doc title to it
        document.title = router.ActiveLink.toString().substring(0,1).toUpperCase() + router.ActiveLink.substring(1);
        //clears all active links
        $("ul>il>a").each(function(){
    ...
    function LoadContent():void | undefined
    {
    ...
    function DisplayContactPage():void
    {
       ...
       $("a[data='contact-list']").on("click", function(){
        ...
        sendButton.addEventListener("click", function(event)
        {
            ...
            let fullname = document.forms[0].fulName.value as string;
            let contactNumber = document.forms[1].contactNumber.value as string;
            let emailAddress = document.forms[2].emailAddress.value as string;
